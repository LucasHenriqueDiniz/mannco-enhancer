...
export const DEFAULT_SETTINGS: Settings = {
  ...
  profileExportTransactions: true,
  profileExportCashouts: true,
  profileExportBuyOrders: true,
  profileRemoveAllBuyOrders: false,
  profileImproveDeleteHitbox: true,
...
export async function getSettings(): Promise<Settings> {
  ...
  return {
    ...
    profileExportTransactions: Boolean(data.profileExportTransactions),
    profileExportCashouts: Boolean(data.profileExportCashouts),
    profileExportBuyOrders: Boolean(data.profileExportBuyOrders),
    profileRemoveAllBuyOrders: Boolean(data.profileRemoveAllBuyOrders),
    profileImproveDeleteHitbox: Boolean(data.profileImproveDeleteHitbox),
